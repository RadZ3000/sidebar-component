  ...
  return (
    <div>
      ...
      <div className="min-h-screen w-20 bg-gray-700 text-slate-300 flex flex-col items-center">
        <a href="#" className="flex justify-center w-full bg-orange-400 py-3 text-4xl text-black hover:text-white"><FaComments /></a>
        ...
        <div className="flex justify-center"><a href="#" className="absolute bottom-10 rounded-full bg-white text-black w-max h-max text-xl p-3 hover:bg-black hover:text-white"><FaUser /></a></div>
      </div>
